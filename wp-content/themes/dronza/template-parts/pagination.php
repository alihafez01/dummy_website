<?php
/**
 * A template partial to output pagination for the Dronza default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Newer <span class="nav-short">Posts</span>', 'dronza' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'dronza' ),
...
if ( $posts_pagination ) { ?>
	...
	<div class="pagination-wrapper section-inner">
		...
		<?php echo wp_kses($posts_pagination,$dronza_allowed_html); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- already escaped during generation. ?>
