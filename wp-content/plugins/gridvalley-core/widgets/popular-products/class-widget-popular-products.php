...
add_action( 'widgets_init', 'dronza_popular_products_widget' );
if( !function_exists('dronza_popular_products_widget') ){
	function dronza_popular_products_widget() {
		register_widget( 'Widget_Popular_Products' );
	}
}	
	
class Widget_Popular_Products extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( false, esc_attr__( 'Dronza: Popular Products', 'gridvalley-core' ), $widget_ops );
	}
